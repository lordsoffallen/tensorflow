"""
Reads Darknet19 config and weights and creates tf.Keras model
Currently only supports layers in Darknet19 config.
"""

from tensorflow.python.keras.layers import Conv2D, GlobalAveragePooling2D, Input, Lambda, MaxPooling2D
...
from yad2k.yolo_v2 import space_to_depth_x2
...
parser.add_argument('--configs', type=str, help='Path to Darknet cfg file.')
parser.add_argument('--weights', type=str, help='Path to Darknet weights file.')
parser.add_argument('--outputs', type=str, help='Path to output Keras model file.')
parser.add_argument('-p', '--plot_model', help='Plot generated model and save as image.', action='store_true')
